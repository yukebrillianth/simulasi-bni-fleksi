...
export default function SimulatorNew() {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    console.log();
    setMaxCredit(calculatePV(sukuBunga, period, monthlyIncome * 0.6));
  }
            ...
            >
              <div className="grid lg:grid-cols-2 gap-10">
                ...
                <div className="col-span-2 -mb-10">
                  <h4 className="text-xl font-bold">Dengan Pinjaman Lainnya</h4>
                  <div className="flex flex-col lg:flex-row mb-4">
                    <div className="flex-1 lg:max-w-2xl">
                      <div className="space-y-0.5 my-5">
                        ...
                        <h4 className="text-2xl font-bold tracking-tight text-red-600">
                  ...
                  <h4 className="text-xl font-bold">Dengan BNI Fleksi</h4>
                  <div className="flex flex-col lg:flex-row">
                    <div className="flex-1 lg:max-w-2xl">
                      <div className="space-y-0.5 my-5 text-green-600">
                        <p className="text-muted-foreground">
                          Angsuran Per Bulan
                        </p>
                        <h4 className="text-2xl font-bold tracking-tight">
